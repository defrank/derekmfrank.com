...
DATABASES = {
    'default': {
        ...
        'NAME': 'dmfdb',                      # Or path to database file if using sqlite3.
        'USER': 'dmfrank',                      # Not used with sqlite3.
        'PASSWORD': 'bugnem2125',                  # Not used with sqlite3.
        'HOST': 'mysql.derekmfrank.com',                      # Set to empty string for localhost. Not used with sqlite3.
...
#MEDIA_URL = os.path.join(os.getenv('PWD'), os.pardir, 'public/media/').replace('\\','/')
MEDIA_URL = '/media/'
