# $Id: settings.py,v 1.8 2013-06-24 17:07:30-07 dmf - $
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PACKAGE_ROOT, 'mysite.db').replace('\\','/'), # Or path to database file if using sqlite3.
...
MEDIA_ROOT = os.path.abspath(os.path.join(PACKAGE_ROOT, 'media').replace('\\','/'))
